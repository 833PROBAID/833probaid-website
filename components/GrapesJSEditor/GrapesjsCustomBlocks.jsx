const loadCustomBlocks = (editor) => {
  ...
  <div class="conclusion-block">
    <div style="filter: drop-shadow(rgba(0, 0, 0, 0.9) 0px 0px 18px); transform: translateZ(0); will-change: filter">
      <div class="conclusion-content">
        <h2 class="section-title text-secondary">
          LET US KEEP YOUR CASE CLEAN AND COMPLIANT
        </h2>
        <p
          class="body-text text-secondary text-bold"
          style="margin-bottom: 1.5rem"
        >
          If you are handling a probate or conservatorship case and want it
          managed properly from the beginning, I am ready to step in and take
          care of the entire real estate lane.
        </p>
          ...
          >
            ...
            <div class="body-text text-bold" style="line-height: 1.1">
              <span class="text-secondary text-bold"
                >(833) <span style="letter-spacing: 0.07em">PROBAID</span></span
              ><br />
              <span
