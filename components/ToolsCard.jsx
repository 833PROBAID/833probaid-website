      ...
      <div className="w-full">
        ...
        >
          <style>{`
						...
						.tc-card-first.tc-card-wrapper:hover .tc-icon-wrapper,
						.tc-card-first.tc-card-wrapper:has(.tc-button-float:hover) .tc-icon-wrapper {
							transform: rotate(-12deg) scale(1.1);
						}
						.tc-card-last.tc-card-wrapper:hover .tc-icon-wrapper,
						.tc-card-last.tc-card-wrapper:has(.tc-button-float:hover) .tc-icon-wrapper {
							transform: rotate(12deg) scale(1.1);
						}
						.tc-button-float {
							animation: tcFloat 2.5s ease-in-out infinite;
						...
						.tc-card-first .tc-button-float:hover .tc-button-wrapper {
							transform: rotate(-2deg) scale(1.08);
						}
						.tc-card-last .tc-button-float:hover .tc-button-wrapper {
							transform: rotate(2deg) scale(1.08);
						}
