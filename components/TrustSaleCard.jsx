...
/**
 * ProbateCard — Figma-accurate rebuild
 * ───────────────────────────────────────────────────────────────────
 * Key corrections vs. previous version:
 *   • Outer card now shares the chamfered bottom-left corner
 *   • Title forced to 4-line wrap (STREAMLINING / PROBATE REAL ESTATE
 *     / SALES WITH / PRECISION.)
 *   • Right-side tabs are rectangular (sharp left, 3px radius right),
 *     no longer pill-shaped
 *   • Tighter, deeper drop shadow with asymmetric offset
 *   • Title font-weight pushed to 800, line-height 1.1
 *   • LEARN MORE letter-spacing increased to 0.18em
 *   • Clock icon hands re-aligned; stroke weight refined
 * ───────────────────────────────────────────────────────────────────
 */
