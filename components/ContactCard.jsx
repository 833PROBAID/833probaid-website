  ...
  return (
    <div>
      <div className="relative  h-[500px] overflow-hidden sm:w-[450px] w-[350px] mx-auto ">
        ...
        {/* Content */}
        <div className="absolute inset-0 z-20 flex items-center justify-center text-center text-black sm:px-20 px-16">
          <div>
            <div className="relative max-w-[350px] sm:-mt-10 -mt-6">
              <h2 className="text-secondary text-center text-xl sm:text-[30px] font-bold floating-text">
                Contact Us
              </h2>
