...
export default function Footer() {
  return (
    <footer className="bg-primary/35 border-primary mt-8 border-y-2 md:mt-12 pt-12">
      <div className="bg-secondary  py-2 mt-0.5" style={{ boxShadow: "0 4px 4.6px rgba(0,0,0,0.62), 0 0 6px rgba(255,255,255,0.25), 0px 10px 12.7px 0px #000000A1, 0px -8px 12.7px 0px #000000A1" }}>
