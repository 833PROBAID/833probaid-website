...
export default function ReferralViewPage() {
	...
	const [pdfModal, setPdfModal] = useState(null); // { src, name }
				...
				<div className='mb-8 rounded-xl border border-gray-200 bg-white p-6 shadow-sm'>
					...
					<div className='grid gap-3 sm:grid-cols-2 lg:grid-cols-3'>
						{uploadedFiles.map((file, i) => {
							...
							const cardClass =
								"flex items-center gap-3 rounded-xl border border-gray-200 px-4 py-3 text-sm text-primary hover:bg-primary/5 hover:border-primary transition-colors text-left w-full";
							const cardInner = (
								<>
