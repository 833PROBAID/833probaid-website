    ...
    return (
      ...
      >
        ...
        <div className="relative w-full" ref={dropdownRef}>
          {disabled ? (
            <div
              className={`w-full ${borderSize} border-[#0097A7] ${padding} bg-gray-200 transition-colors cursor-not-allowed ${textStyle} ${inputClass} flex items-center leading-normal`}
              style={{ minHeight: isLarge ? "3.1rem" : "2.2rem" }}
            >
              {value || ""}
            </div>
          ) : (
          ...
          {/* Loading indicator */}
          {!disabled && isLoadingSuggestions && showDropdown && (
            <div
...
export const DateSelector = ({
  ...
  const dateDisplayValue = formatDateForDisplay(selected);
  ...
  return (
    ...
    >
      ...
      {disabled ? (
        <div
          className={`w-full ${borderSize} border-[#0097A7] ${padding} bg-gray-200 transition-colors cursor-not-allowed ${textStyle} flex items-center leading-normal`}
          style={{ minHeight: isLarge ? "3.1rem" : "2.2rem" }}
        >
          {dateDisplayValue}
        </div>
    ...
    >
      <div className="relative bg-[#0097A7] py-2 pl-16 text-white font-semibold text-3xl uppercase">
        <div className="absolute left-4 top-1/2 transform -translate-y-1/2 -translate-x-1/2 w-[4rem] h-[4rem] rounded-full bg-[#FD7702] flex items-center justify-center z-10 border-[6px] border-[#0097A7]">
          <i className={`fas ${icon} form-section-icon flex items-center justify-center mb-[2px]`}></i>
        </div>
