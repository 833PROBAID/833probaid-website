...
import Form2 from "../../../../components/Forms/Vendor";
...
const FILE_FIELD_LABELS = {
	...
	coiFile: "Certificate of Insurance",
	bondCertFile: "Bond Certificate",
	certificationFile: "Translation Certification",
};
	...
	return (
		<div
			...
			<div
				...
				<div
					className='relative w-full overflow-hidden rounded-b-xl bg-gray-800'
...
export default function VendorViewPage() {
	...
	const uploadedFiles = vendor?.uploadedFiles || [];
		...
		<div>
				...
				<div className='flex items-center gap-3'>
					...
					<div>
						<h1 className='font-anton text-3xl text-gray-900'>
							{vendor.businessName || vendor.yourName || "Vendor Detail"}
						</h1>
						<p className='font-montserrat mt-1 text-sm text-gray-500'>
							Submitted on{" "}
							{new Date(vendor.submittedAt || vendor.createdAt).toLocaleDateString("en-US", {
								weekday: "short",
								month: "long",
								day: "numeric",
								year: "numeric",
				...
				<div className='mb-8 rounded-xl border border-gray-200 bg-white p-6 shadow-sm'>
					...
					<div className='grid gap-3 sm:grid-cols-2 lg:grid-cols-3'>
						{uploadedFiles.map((file, i) => {
							...
							const originalName =
								typeof file === "object" && file.originalName
									? file.originalName
									: filePath.split("/").pop();
							...
							const sizeLabel =
								typeof file === "object" && file.size
									...
									: "";
							const mimeLabel =
								typeof file === "object" && file.mimeType ? file.mimeType : "";
							const categoryLabel =
								typeof file === "object" && file.fieldName
									? FILE_FIELD_LABELS[file.fieldName] || file.fieldName
									: "";
							...
							return (
								<a
									...
									<div className='flex flex-col min-w-0'>
										{categoryLabel && (
											<span className='text-xs font-semibold text-primary uppercase tracking-wide mb-0.5'>
												{categoryLabel}
											</span>
										)}
			...
			<div className='rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden'>
				...
				<div className='p-4 sm:p-6'>
					<Form2 readOnly={true} initialData={vendor} />
				</div>
			</div>
		</div>
	);
