...
const normalizeCanonicalUrl = (value = "") => {
  ...
  if (trimmed.startsWith("homebooks/"))
    return `https://833probaid.com/${trimmed}`;
...
const initialHomeBookContent = {
  ...
  hero: {
    bannerImage: "/images/footer-logo.png",
    icon: "",
    title: "Getting Started with Estate Planning",
...
export default function HomeBookEditPage() {
  ...
  const [homeBookContent, setHomeBookContent] = useState(
    ...
    try {
      ...
      if (response.success && response.homeBook) {
        ...
        const seo = {
          ...
          structuredData: loadedSeo.structuredData
  ...
  const handleSaveHomeBook = async () => {
    ...
    try {
      ...
      if (!slug) {
        setActiveTab("seo");
        setSaveStatus("error");
        alert("Please add a slug at the end of Canonical URL in SEO Settings.");
        return;
      }
  ...
  const handleExport = () => {
    const dataStr = JSON.stringify({ homeBookContent, grapesContent }, null, 2);
      ...
      reader.onload = (event) => {
        try {
          ...
          if (parsed.homeBookContent || parsed.grapesContent) {
            if (parsed.homeBookContent)
              setHomeBookContent(parsed.homeBookContent);
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="font-montserrat mx-auto px-4 py-8">
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      rows={3}
                      value={homeBookContent.metadata?.description || ""}
                      onChange={(e) =>
                        setHomeBookContent({
                          ...homeBookContent,
                          metadata: {
                      ...
                      placeholder="A description for your home book"
                      className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                    />
                  </div>
          ...
          {activeTab === "seo" && (
            <div className="space-y-6">
              <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                <h2 className="font-anton mb-1 text-2xl text-gray-900">
                  SEO Settings
                </h2>
                <p className="font-montserrat mb-6 text-sm text-gray-500">
                  Control how this home book appears in search engines and
                  social media.
                </p>

                <h3 className="font-montserrat mb-3 text-xs font-bold uppercase tracking-widest text-gray-400">
                  Search Engine
                </h3>
                <div className="mb-8 space-y-4">
                  <div>
                    <label className="font-montserrat mb-1 block text-sm font-semibold text-gray-700">
                      Meta Title{" "}
                      <span className="font-normal text-gray-400">
                        (leave blank to use title)
                      </span>
                    </label>
                    <input
                      type="text"
                      ...
                      placeholder={
                        homeBookContent.hero?.title || "Home book title"
                      }
                      maxLength={60}
                    ...
                    />
                    <p className="mt-1 text-right font-montserrat text-xs text-gray-400">
                      {(homeBookContent.seo?.metaTitle || "").length}/60
                    </p>
                  </div>
                  <div>
                    <label className="font-montserrat mb-1 block text-sm font-semibold text-gray-700">
                      Meta Description{" "}
                      <span className="font-normal text-gray-400">
                        (leave blank to use description)
                      </span>
                    </label>
                    <textarea
                      rows={3}
                      ...
                      placeholder={
                        homeBookContent.metadata?.description ||
                    ...
                    />
                    <p className="mt-1 text-right font-montserrat text-xs text-gray-400">
                      {(homeBookContent.seo?.metaDescription || "").length}/160
                    </p>
                  </div>
                  <div>
                    <label className="font-montserrat mb-1 block text-sm font-semibold text-gray-700">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-gray-300 px-4 py-2 font-montserrat focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                    />
                    <p className="mt-1 font-montserrat text-xs text-gray-400">
                      Slug is taken from the last part of this URL.
                    </p>
                ...
                <div className="mb-8 space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder={
                        homeBookContent.seo?.metaDescription ||
                        homeBookContent.metadata?.description ||
                        ""
                      }
                      className="w-full rounded-lg border border-gray-300 px-4 py-2 font-montserrat focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                ...
                <div className="mb-8 space-y-4">
                  <div>
                    ...
                    <select
                      value={
                        homeBookContent.seo?.twitterCard ||
                        "summary_large_image"
                      }
                      onChange={(e) =>
                        setHomeBookContent({
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder={
                        homeBookContent.seo?.ogDescription ||
                        homeBookContent.seo?.metaDescription ||
                        homeBookContent.metadata?.description ||
                        ""
                      }
                  ...
                  <div>
                    <label className="font-montserrat mb-1 block text-sm font-semibold text-gray-700">
                      Twitter Image URL (optional override)
                    </label>
                    <div className="flex gap-2">
                      <input
                        type="text"
                ...
                <div className="space-y-2">
                  <p className="font-montserrat text-xs text-gray-500">
                    Paste valid JSON-LD. Leave blank to skip. Common types:
                  ...
                  <textarea
                    ...
                    onChange={(e) => {
                      ...
                      setHomeBookContent({
                        ...homeBookContent,
                        seo: { ...homeBookContent.seo, structuredData: val },
                      });
                      if (val.trim() === "") {
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      onClick={() => {
                        ...
                        setHomeBookContent({
                          ...
                          seo: {
                            ...homeBookContent.seo,
                            structuredData: JSON.stringify(template, null, 2),
                          },
                        });
                        setSeoStructuredDataError("");
                      }}
                    ...
                    <button
                      ...
                      onClick={() => {
                        setHomeBookContent({
                          ...homeBookContent,
                          seo: { ...homeBookContent.seo, structuredData: "" },
                        });
                        setSeoStructuredDataError("");
                      }}
