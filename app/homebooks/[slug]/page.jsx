...
export default async function HomeBookDetailPage({ params }) {
  ...
  return (
    <section className="font-montserrat">
      ...
      <div className="hidden mt-0! !mb-0 !p-6 !pb-[2.5rem] !py-0 !h-auto relative bottom-1.5 !bottom-[0.6rem] bottom-5 !ml-16 !mx-[25px]" />
      <div className="hidden !relative !pt-[2.5rem] !mb-[1.5rem] !mb-[1.2rem] !mt-[1.5rem] !mt-[2.5rem] !mt-[1.2rem] !mb-[2.5rem] !mt-6" />
      <div className="hidden !mt-0 mb-[0.5rem] !pb-[2rem] !pt-[2.2rem] !py-[2.5rem] !mt-[4rem] !mb-[-0.1em] !mb-[-0.07em] !mb-[1rem]" />
