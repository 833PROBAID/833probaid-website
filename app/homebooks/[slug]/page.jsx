...
export default async function HomeBookDetailPage({ params }) {
  ...
  return (
    <section className="font-montserrat">
      ...
      <div className="hidden !relative !pt-[2.5rem] !mb-[1.5rem] !mb-[1.2rem] !pt-[1.5rem] !pt-[2rem] !mt-[1.5rem] !mt-[2.5rem] !mt-[1.2rem] !mb-[2.5rem] !mt-6 !border-primary group-hover:!border-secondary" />
